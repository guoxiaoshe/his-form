<template>
  <div id="app">
      ...
      <div class="_fc-top-nav">
        <div class="_fc-top-copyright">
          <img
            ...
            alt="logo"
          />
          <div class="_fc-t-name">
            <span
              >FcDesigner |
              <span style="font-size: 14px">Element Plus 开源版</span></span
            >
          </div>
        </div>
          ...
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item @click="setOption"
                  >导入Options</el-dropdown-item
                >
              </el-dropdown-menu>
            </template>
          </el-dropdown>
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item @click="showOption"
                  >生成Options</el-dropdown-item
                >
                <el-dropdown-item @click="copyUrl"
                  >生成预览链接</el-dropdown-item
                >
              </el-dropdown-menu>
            </template>
          </el-dropdown>
    ...
    <ConfigPanel :menus="menus" @change="panelChange" />
  </div>
</template>
...
import ZhCn from "@/components/FcDesigner/locale/zh-cn";
import En from "@/components/FcDesigner/locale/en";
import { ArrowDown } from "@element-plus/icons-vue";
import { copyTextToClipboard } from "@/components/FcDesigner/utils";
...
._fd-view-product {
  ...
  border-radius: 4px;
  box-shadow: rgb(3 51 123 / 8%) 0 5px 15px 1px;
  opacity: 0.95;
