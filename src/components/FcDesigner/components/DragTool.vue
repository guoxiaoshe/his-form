<template>
  <div
    class="_fd-drag-tool"
    @click.stop="active"
    :class="{ active: fcx.active === id }"
  >
    <div class="_fd-drag-mask" v-if="mask"></div>
    <div
      class="_fd-drag-l"
      v-if="!hiddenBtn && permission.move !== false"
      @click.stop
    >
      <div
        class="_fd-drag-btn"
    ...
    <div
      class="_fd-drag-r"
      v-if="btns !== false && !hiddenMenu && permission.dragMenu !== false"
    >
      <slot name="handle">
        <div
          class="_fd-drag-btn"
          v-if="
            ...
            isCreate &&
            (btns === true || btns.indexOf('create') > -1)
          "
        ...
        <div
          class="_fd-drag-btn"
          v-if="
            permission.addChild !== false &&
            children &&
            (btns === true || btns.indexOf('addChild') > -1)
          "
        ...
        <div
          ...
          v-if="
            ...
            (btns === true || btns.indexOf('delete') > -1)
          "
