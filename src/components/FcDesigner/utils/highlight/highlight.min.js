...
const Y = n,
  ...
  te = n => {
    ...
    function E(e, n, s, r) {
      ...
      function l() {
        if (!N.keywords) return M.addText(R);
        let e = 0;
        ...
        return (
          ...
          e.beginScope &&
            (e.beginScope._wrap
              ? (u(
                  R,
                  _.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap
                ),
                (R = ""))
      ...
      try {
        if (_.__emitTokens) _.__emitTokens(n, M);
          ...
          for (N.matcher.considerAll(); ; ) {
            ...
            if (!e) break;
            const t = y(n.substring(j, e.index), e);
            j = e.index + t;
          }
          y(n.substring(j));
        }
    ...
    for (const t in A) "object" == typeof A[t] && e(A[t]);
